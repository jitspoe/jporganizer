...
// Tag panel for adding tags to images
class CTagPanel : public CPanel {
public:
...
public:
	...
	CButtonCtrl* GetBtnDelete() { return GetControl<CButtonCtrl*>(ID_btnDelete); }
...
private:
	...
	static void PaintDeleteBtn(void* pContext, const CRect& rect, CDC& dc);
