...
CTagPanel::CTagPanel(HWND hWnd, INotifiyMouseCapture* pNotifyMouseCapture, CPanel* pImageProcPanel, CKeyMap* keyMap, bool* pFullScreenMode,
...
CString CTagPanel::GetTooltip(CKeyMap* keyMap, LPCTSTR tooltip, int command)
{
...
void CTagPanel::AddGap(int nID, int nGap) {
	CGapCtrl* pGapCtrl = new CGapCtrl(this, nGap);
	m_controls[nID] = pGapCtrl;
}

CRect CTagPanel::PanelRect() {
	if (m_nWidth == 0) {
		int nNumButtons = 0;
		int nTotalGap = 0;
	...
	int y = 2;
	m_clientRect = CRect(CPoint(x, y), CSize(m_nWidth, m_nHeight));
	return m_clientRect;
}

bool CTagPanel::AdjustMaximalWidth(int nMaxWidth) {
...
void CTagPanel::RequestRepositioning() {
	RepositionAll();
}
...
void CTagPanel::SetScaledWidth(float fScale) {
...
void CTagPanel::PaintPrevBtn(void* pContext, const CRect& rect, CDC& dc) {
	CRect r = Helpers::InflateRect(rect, 0.3f);
...
void CTagPanel::PaintNextBtn(void* pContext, const CRect& rect, CDC& dc) {
	CRect r = Helpers::InflateRect(rect, 0.3f);
...
void CTagPanel::PaintEndBtn(void* pContext, const CRect& rect, CDC& dc) {
	CRect r = Helpers::InflateRect(rect, 0.3f);
...
void CTagPanel::PaintDeleteBtn(void* pContext, const CRect& rect, CDC& dc) {
	CRect r = Helpers::InflateRect(rect, 0.3f);
...
void CTagPanel::PaintZoomModeBtn(void* pContext, const CRect& rect, CDC& dc) {
...
void CTagPanel::PaintZoomToFitBtn(void* pContext, const CRect& rect, CDC& dc) {
	CRect r = Helpers::InflateRect(rect, 0.25f);
...
void CTagPanel::PaintZoomTo1to1Btn(void* pContext, const CRect& rect, CDC& dc) {
	CFont font;
...
void CTagPanel::PaintZoomFitToggleBtn(void* pContext, const CRect& rect, CDC& dc) {
	CTagPanel* pNavPanel = (CTagPanel*)pContext;
...
void CTagPanel::PaintWindowModeBtn(void* pContext, const CRect& rect, CDC& dc) {
	CRect r = Helpers::InflateRect(rect, 0.25f);
...
void CTagPanel::PaintRotateCWBtn(void* pContext, const CRect& rect, CDC& dc) {
	CRect r = Helpers::InflateRect(rect, 0.3f);
...
void CTagPanel::PaintRotateCCWBtn(void* pContext, const CRect& rect, CDC& dc) {
	CRect r = Helpers::InflateRect(rect, 0.3f);
...
void CTagPanel::PaintFreeRotBtn(void* pContext, const CRect& rect, CDC& dc) {
...
void CTagPanel::PaintPerspectiveBtn(void* pContext, const CRect& rect, CDC& dc) {
	CRect r = Helpers::InflateRect(rect, 0.3f);
...
void CTagPanel::PaintKeepParamsBtn(void* pContext, const CRect& rect, CDC& dc) {
	CRect r = Helpers::InflateRect(rect, 0.25f);
...
void CTagPanel::PaintLandscapeModeBtn(void* pContext, const CRect& rect, CDC& dc) {
	CRect r = Helpers::InflateRect(rect, 0.3f);
...
void CTagPanel::PaintInfoBtn(void* pContext, const CRect& rect, CDC& dc) {
	CFont font;
...
LPCTSTR CTagPanel::WindowModeTooltip(void* pContext) {
	CTagPanel* pNavPanel = (CTagPanel*)pContext;
...
LPCTSTR CTagPanel::ZoomFitToggleTooltip(void* pContext) {
	CTagPanel* pNavPanel = (CTagPanel*)pContext;
	if (pNavPanel->m_isCurrentImageFitToScreen(pNavPanel->m_pDecisionMethodParam)) {
